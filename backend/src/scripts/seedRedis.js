...
const cargarCombustible = async () => {
  try {
    ...
    const reglasUniversales = [
      ...
      // ==========================================
      { 
        origen: "UK", destino: "AR", version: "2.0", 
        normativa: "Res. Ministerial 450/24 - Convenio Bilateral", 
        organismo: "Ministerio de Educación AR",
        mapping: [
      ...
      { 
        origen: "US", destino: "AR", version: "1.0", 
        normativa: "Acuerdo de Cooperación Educativa AR-US", 
        organismo: "Ministerio de Educación AR",
        mapping: [
      ...
      { 
        origen: "DE", destino: "AR", version: "1.0", 
        normativa: "Tratado de Reconocimiento Mutuo de Títulos", 
        organismo: "Ministerio de Educación AR",
        mapping: [
      ...
      { 
        origen: "ZA", destino: "AR", version: "1.0", 
        normativa: "Protocolo de Equivalencias BRICS-Edu", 
        organismo: "Ministerio de Educación AR",
        mapping: [
      ...
      // ==========================================
      { 
        origen: "AR", destino: "US", version: "1.1", 
        normativa: "WES Standard - Latin American Equiv.", 
      ...
      { 
        origen: "UK", destino: "US", version: "1.0", 
        normativa: "Fullbright Commission Academic Scale", 
        organismo: "U.S. Dept of Education",
        mapping: [
      ...
      { 
        origen: "DE", destino: "US", version: "1.0", 
        normativa: "German-American Fulbright Program Rules", 
        organismo: "U.S. Dept of Education",
        mapping: [
      ...
      { 
        origen: "ZA", destino: "US", version: "1.0", 
        normativa: "International GPA Calculation Standard", 
        organismo: "World Education Services (WES)",
        mapping: [
      ...
      // ==========================================
      { 
        origen: "AR", destino: "UK", version: "1.0", 
        normativa: "UK ENIC (National Information Centre) Guide", 
        organismo: "Department for Education (UK)",
        mapping: [
      ...
      { 
        origen: "US", destino: "UK", version: "1.0", 
        normativa: "British Council USA - Equivalency Table", 
        organismo: "Department for Education (UK)",
        mapping: [
      ...
      { 
        origen: "DE", destino: "UK", version: "1.0", 
        normativa: "EU Academic Mobility Standards", 
        organismo: "Department for Education (UK)",
        mapping: [
      ...
      { 
        origen: "ZA", destino: "UK", version: "1.0", 
        normativa: "Commonwealth Equivalence Framework", 
        organismo: "Department for Education (UK)",
        mapping: [
      ...
      // ==========================================
      { 
        origen: "AR", destino: "DE", version: "1.2", 
        normativa: "Modifizierte Bayerische Formel", 
        organismo: "Anabin - KMK",
        mapping: [
          { min: 10.0, max: 10.0, result: "1.0", label: "Sehr Gut" },
          { min: 8.0, max: 9.9, result: "2.0", label: "Gut" },
          { min: 4.0, max: 7.9, result: "4.0", label: "Pass" },
          { min: 0.0, max: 3.9, result: "5.0", label: "Fail" }
        ]
      },
      { 
        origen: "US", destino: "DE", version: "1.0", 
        normativa: "DAAD International Student Scale", 
        organismo: "Kultusministerkonferenz (KMK)",
        mapping: [
      ...
      { 
        origen: "UK", destino: "DE", version: "1.0", 
        normativa: "Recognition of UK Qualifications - Brexit Update", 
        organismo: "Anabin - KMK",
        mapping: [
      ...
      { 
        origen: "ZA", destino: "DE", version: "1.0", 
        normativa: "Bilateral Agreement on Higher Education", 
        organismo: "Kultusministerkonferenz (KMK)",
        mapping: [
      ...
      // ==========================================
      { 
        origen: "AR", destino: "ZA", version: "1.0", 
        normativa: "South African Qualifications Act (SAQA) 2026", 
        organismo: "SAQA - International Unit",
        mapping: [
      ...
      { 
        origen: "US", destino: "ZA", version: "1.0", 
        normativa: "National Senior Certificate (NSC) Equivalency", 
        organismo: "Department of Higher Education ZA",
        mapping: [
      ...
      { 
        origen: "UK", destino: "ZA", version: "1.0", 
        normativa: "International GCSE Recognition Framework", 
        organismo: "SAQA",
        mapping: [
      ...
      { 
        origen: "DE", destino: "ZA", version: "1.0", 
        normativa: "Bilateral Recognition Agreement DE-ZA", 
        organismo: "SAQA - Evaluation of Foreign Qual.",
        mapping: [
    ...
    console.log('⛽ Cargando matriz normativa completa de 20 reglas en Redis...');
    
    for (const regla of reglasUniversales) {
      await ConversionService.guardarRegla(regla);
      console.log(`✅ [${regla.normativa}] ${regla.origen} ➔ ${regla.destino}`);
    }

    console.log('✨ Matriz de movilidad legalizada y cargada con éxito.');
    process.exit(0);
